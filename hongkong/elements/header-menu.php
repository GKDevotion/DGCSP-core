            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                ...
                <div class="collapse navbar-collapse flex-column align-items-end" id="devotionNavbar">
                    ...
                    <ul class="navbar-nav ms-auto align-items-lg-center">
                        ...
                        <!-- Corporate Structure -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="<?= getJurisditionLink('hongkong') ?>/corporate-structure"><!-- role="button" data-bs-toggle="dropdown" aria-expanded="false" -->
                                Corporate Structure
                            </a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?= getJurisditionLink('hongkong') ?>/corporate-structure#setup-strategy">Company Setup Strategy</a></li>
                                <li><a class="dropdown-item" href="<?= getJurisditionLink('hongkong') ?>/corporate-structure#entity-type">Business Entity Type</a></li>
                                <li><a class="dropdown-item" href="<?= getJurisditionLink('hongkong') ?>/corporate-structure#14-steps">14 Steps to Register on LLC</a></li>
                                <li><a class="dropdown-item" href="<?= getJurisditionLink('hongkong') ?>/corporate-structure#offshore-company">OffShore Company</a></li>
                                <li><a class="dropdown-item" href="<?= getJurisditionLink('hongkong') ?>/corporate-structure#transfer-in">Company Transfer-IN</a></li>
                                <li><a class="dropdown-item" href="<?= getJurisditionLink('hongkong') ?>/corporate-structure#llp">Lilmited Liability Partnerships?</a></li>
                                <li><a class="dropdown-item" href="<?= getJurisditionLink('hongkong') ?>/corporate-structure#holding-company">Registered in Holding Company</a></li>
                                <li><a class="dropdown-item" href="<?= getJurisditionLink('hongkong') ?>/corporate-structure#asian-holding">Asian Holding Company</a></li>
                                <li><a class="dropdown-item" href="<?= getJurisditionLink('hongkong') ?>/corporate-structure#global-lp">Global LP Holding Companies</a></li>
                            </ul>
                        </li>

...
<main>
        ...
        <section class="sg-hero-section">
            <div class="container">
                <div class="row align-items-center gy-4">
                    <div class="col-lg-7">
                        <span class="badge-gold"><i class="fa-solid fa-shield-halved me-1"></i> Hong Kong Jurisdiction Excellence</span>
                        <h1 class="display-6 fw-bold text-dark mb-3">Enterprise-Grade Customer Experience Hubs in Hong Kong</h1>
                        <p class="lead text-muted mb-4">Empowering global financial institutions, SaaS platforms, and e-commerce leaders with Companies Registry-compliant, multilingual customer service solutions operated out of Asia's premier financial gateway.</p>
                        <div class="d-flex flex-wrap gap-3 mb-4">
                            <button class="btn btn-gold btn-lg" onclick="navigateToPage('inquiry')">Custom HK Proposal <i class="fa-solid fa-arrow-right ms-2"></i></button>
                        ...
                        <div class="row g-3 pt-2 text-center text-sm-start">
                            <div class="col-6 col-sm-4">
                                ...
                                <small class="text-muted">CR & PDPO Compliant</small>
                            </div>
                            <div class="col-6 col-sm-4">
                    ...
                    <div class="col-lg-5">
                        <div class="card-custom p-4 border-2">
                            <h4 class="fw-bold mb-3"><i class="fa-solid fa-briefcase text-warning me-2"></i> Hong Kong Quick Setup</h4>
                            <ul class="list-unstyled mb-4">
                                <li class="d-flex align-items-start mb-3">
                                    <i class="fa-solid fa-circle-check text-success mt-1 me-2"></i>
                                    <div><strong>Profits Tax Rate:</strong> 16.5% standard rate, with 8.25% two-tiered rate on the first HK$2M of profits.</div>
                                </li>
                                <li class="d-flex align-items-start mb-3">
                                    <i class="fa-solid fa-circle-check text-success mt-1 me-2"></i>
                                    <div><strong>Location Tier:</strong> Grade-A Office Hubs (Central, Kowloon East, Cyberport).</div>
                                </li>
                                <li class="d-flex align-items-start mb-3">
                                    <i class="fa-solid fa-circle-check text-success mt-1 me-2"></i>
                                    <div><strong>Talent Capabilities:</strong> Native English, Cantonese, Mandarin & regional Asian language support personnel.</div>
                                </li>
                                <li class="d-flex align-items-start">
                                    <i class="fa-solid fa-circle-check text-success mt-1 me-2"></i>
                                    <div><strong>Min Setup Capital:</strong> Starting from ~HK$10,000 for boutique operational hubs.</div>
                                </li>
                            </ul>
                            <button class="btn btn-gold w-full w-100" onclick="navigateToPage('rules')">Explore HK Rules & Regulations</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-5 bg-light">
            <div class="container">
                <div class="section-title-wrap">
                    ...
                    <p class="text-muted">How Devotion Global structures profitable client support outsourcing frameworks in Hong Kong.</p>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        <div class="card-custom p-4">
                            ...
                            <p class="text-muted">Fixed monthly seat-based or team-based retainer contracts for enterprises seeking dedicated support teams stationed in Hong Kong office hubs. Provides predictable cash flow and guaranteed SLA performance.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="card-custom p-4">
                            ...
                            <p class="text-muted">Premium revenue streams derived from providing multi-lingual support (English, Cantonese, Mandarin, Japanese) across Greater China and APAC from Hong Kong's gateway jurisdiction.</p>
                            <ul class="list-unstyled text-muted small">
        ...
        <section class="py-5">
            <div class="container">
                <div class="section-title-wrap">
                    ...
                    <h2 class="section-title">Hong Kong & Greater China Investment Markets</h2>
                    <div class="gold-divider"></div>
                    <p class="text-muted">Key business sectors in Hong Kong requiring high-touch, compliant customer service outsourcing.</p>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4">
                        <div class="card-custom p-4 text-center">
                            ...
                            <p class="text-muted">HKMA (Hong Kong Monetary Authority) and SFC compliant support for crypto exchanges, virtual banks, and payment gateways.</p>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-custom p-4 text-center">
                            ...
                            <p class="text-muted">Omnichannel support for Greater China shopping platforms handling order inquiries, refunds, and VIP shopper care.</p>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-custom p-4 text-center">
                            ...
                            <p class="text-muted">Technical helpdesk and customer success management for B2B software companies expanding across Greater China and APAC.</p>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-custom p-4 text-center">
                            ...
                            <p class="text-muted">Confidential patient and telehealth concierge services adhering to Hong Kong healthcare privacy norms.</p>
    ...
    <div id="page-rules" class="page-view">
        <section class="py-5 bg-light">
            <div class="container">
                <div class="section-title-wrap">
                    <span class="badge-gold">Hong Kong Governance & Real Estate</span>
                    <h2 class="section-title">Office Locations, Rules & Regulations</h2>
                    <div class="gold-divider"></div>
                    <p class="text-muted">Establishing physical customer service centers with full regulatory compliance in Hong Kong.</p>
                </div>
                ...
                <ul class="nav nav-pills nav-pills-custom justify-content-center mb-4" id="rulesTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="tab-offices" data-bs-toggle="pill" data-bs-target="#content-offices" type="button">Strategic HK Office Hubs</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tab-acra" data-bs-toggle="pill" data-bs-target="#content-acra" type="button">CR & PDPO Laws</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tab-mom" data-bs-toggle="pill" data-bs-target="#content-mom" type="button">Immigration Hiring & Visa Regulations</button>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="rulesTabsContent">
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                <div class="card-custom p-4">
                                    ...
                                    <h4>Central Business District (Central)</h4>
                                    ...
                                    <ul class="list-unstyled small text-muted">
                                        <li><i class="fa-solid fa-location-dot me-2 text-warning"></i> Central, Hong Kong Island</li>
                                        <li><i class="fa-solid fa-building me-2 text-warning"></i> HK$85 - HK$110 / sq.ft / mo</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card-custom p-4">
                                    <span class="badge bg-dark text-warning mb-2">Kowloon Business Cluster</span>
                                    <h4>Kowloon East / Kwun Tong Hub</h4>
                                    <p class="text-muted small">Perfect for enterprise customer service hubs and hybrid BPO operations with direct access to MTR interchanges.</p>
                                    <ul class="list-unstyled small text-muted">
                                        <li><i class="fa-solid fa-location-dot me-2 text-warning"></i> Kwun Tong, Kowloon</li>
                                        <li><i class="fa-solid fa-building me-2 text-warning"></i> HK$28 - HK$40 / sq.ft / mo</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card-custom p-4">
                                    ...
                                    <h4>Cyberport / Sha Tin Tech Park</h4>
                                    ...
                                    <ul class="list-unstyled small text-muted">
                                        <li><i class="fa-solid fa-location-dot me-2 text-warning"></i> New Territories, HK</li>
                                        <li><i class="fa-solid fa-building me-2 text-warning"></i> HK$15 - HK$22 / sq.ft / mo</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Companies Registry & PDPO Laws Content -->
                    <div class="tab-pane fade" id="content-acra" role="tabpanel">
                        <div class="card-custom p-4">
                            <h3><i class="fa-solid fa-shield-cat text-warning me-2"></i> Companies Registry & Data Protection Regulations</h3>
                            <hr class="my-3">
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <h5 class="fw-bold">1. Companies Registry Incorporation Requirements</h5>
                                    <p class="text-muted small">Customer service entities must obtain a Business Registration Certificate (BRC) and incorporate under the Companies Ordinance. Requires at least 1 director and a locally based Company Secretary.</p>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="fw-bold">2. PDPO Data Security (Critical)</h5>
                                    <p class="text-muted small">Call recording, customer chat logs, and CRM records must comply with Hong Kong's Personal Data (Privacy) Ordinance (PDPO). Recommended appointment of a Data Protection Officer (DPO) reporting to the PCPD.</p>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="fw-bold">3. Do-Not-Call (DNC) Registers</h5>
                                    <p class="text-muted small">Outbound telemarketing support must check numbers against Hong Kong's DNC registers under the Unsolicited Electronic Messages Ordinance (UEMO) before conducting sales or outreach calls.</p>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="fw-bold">4. ISO 27001 Infrastructure Standard</h5>
                                    <p class="text-muted small">Recommended data center hosting in Hong Kong (e.g., Equinix HK) with end-to-end encrypted VoIP telecommunication links.</p>
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- Immigration Regulations Content -->
                    <div class="tab-pane fade" id="content-mom" role="tabpanel">
                        <div class="card-custom p-4">
                            <h3><i class="fa-solid fa-users-gear text-warning me-2"></i> Immigration Department Employment & Visa Framework</h3>
                            <hr class="my-3">
                            <p class="text-muted">Hong Kong's Immigration Department governs work visa eligibility and fair hiring practices:</p>
                            <div class="table-responsive">
                                <table class="table table-bordered align-middle">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><strong>Employment Visa (GEP)</strong></td>
                                            <td>HK$30,000+ (Higher in FinTech)</td>
                                            <td>CX Directors, Operations Lead</td>
                                            <td>General Employment Policy Assessment</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Top Talent Pass Scheme (TTPS)</strong></td>
                                            <td>HK$25,000+ / Top university graduates</td>
                                            <td>Specialized Tech Support Specialists</td>
                                            <td>No employer sponsorship required at application</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Local Workforce</strong></td>
                                            <td>Market Competitive (HK$16,000 - HK$26,000)</td>
                                            <td>Tier 1 & 2 Multilingual Support Agents</td>
                                            <td>Qualifies for Hong Kong Talent & Business Facilitation grants</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
        ...
        <section class="py-5">
            <div class="container">
                <div class="section-title-wrap">
                    ...
                    <div class="gold-divider"></div>
                    <p class="text-muted">Estimate the capital required to launch a fully compliant customer support operation in Hong Kong.</p>
                </div>
                ...
                <div class="row g-4 align-items-start">
                    ...
                    <div class="col-lg-7">
                        <div class="calc-card">
                            <h4 class="fw-bold mb-3"><i class="fa-solid fa-sliders text-warning me-2"></i> Hong Kong Setup Cost Estimator</h4>
                            <p class="text-muted small mb-4">Adjust parameters to compute estimated setup capital and monthly operational costs in Hong Kong Dollars (HK$).</p>
                            ...
                            <form id="roiCalcForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="supportTier" onchange="updateCostCalculator()">
                                        <option value="1">Tier 1: Basic Helpline & Live Chat (HK$18,000 / agent)</option>
                                        <option value="2" selected>Tier 2: Technical Helpdesk & Multilingual (HK$27,000 / agent)</option>
                                        <option value="3">Tier 3: Enterprise FinTech / VIP Concierge (HK$39,000 / agent)</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="officeType" onchange="updateCostCalculator()">
                                        <option value="virtual">Virtual / Hybrid Remote HK Hub (Lowest Capex)</option>
                                        <option value="coworking" selected>Co-working Dedicated Desk (Central/Kowloon Hub)</option>
                                        <option value="private">Private Lease Dedicated Call Center (Cyberport/Sha Tin)</option>
                                    </select>
                                </div>

                                <div class="p-3 bg-light rounded-3 border mb-3">
                                    <div class="d-flex justify-content-between mb-2">
                                        <span>Est. Initial Setup & Business Registration:</span>
                                        <strong id="initialSetupCost">HK$ 18,500</strong>
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                                        <span>Est. Monthly Operational Opex:</span>
                                        <strong id="monthlyOpexCost">HK$ 160,000 / mo</strong>
                                    </div>
                                    <hr class="my-2">
                                    <div class="d-flex justify-content-between align-items-center text-dark fw-bold fs-5">
                                        <span>Total Min Capex Buffer (3 Mo):</span>
                                        <span style="color: var(--gold-primary);" id="totalCapex">HK$ 550,000</span>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="card-custom p-4">
                            ...
                            <div class="timeline-wrap pt-2">
                                <div class="d-flex mb-3">
                                    ...
                                    <div>
                                        <h6 class="fw-bold mb-1">Week 1: Companies Registry Incorporation & DPO</h6>
                                        <p class="text-muted small mb-0">Entity setup, director & company secretary assignment, bank account opening, and PDPO policy setup.</p>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="me-3 text-center" style="width: 40px;">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small mb-0">SIP trunking, Hong Kong local phone numbers, Zendesk/Freshdesk, and AI Chatbot training.</p>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="me-3 text-center" style="width: 40px;">
        ...
        <section class="py-5 bg-light">
            <div class="container">
                <div class="section-title-wrap">
                    ...
                    <h2 class="section-title">Pros & Cons of Hong Kong Customer Service Setup</h2>
                    <div class="gold-divider"></div>
                    <p class="text-muted">A balanced analysis for decision-makers evaluating Hong Kong versus other regional locations.</p>
                </div>
                        ...
                        <div class="card-custom p-4 border-success border-2">
                            ...
                            <div class="d-flex align-items-start mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Low 16.5% profits tax (8.25% two-tiered rate), 0% capital gains tax, and eligibility for InvestHK and HKTDC business grants.</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-start mb-3">
                                <i class="fa-solid fa-circle-check text-success fs-5 me-3 mt-1"></i>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Native English fluency combined with Cantonese, Mandarin, and regional Asian language capabilities.</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-start">
                                <i class="fa-solid fa-circle-check text-success fs-5 me-3 mt-1"></i>
                                <div>
                                    <h5 class="mb-1">Gateway to Greater China</h5>
                                    <p class="text-muted small mb-0">High trust factor among international enterprise clients when serviced out of a Hong Kong jurisdiction with direct mainland China access.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card-custom p-4 border-danger border-2">
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <i class="fa-solid fa-triangle-exclamation text-danger fs-5 me-3 mt-1"></i>
                                <div>
                                    <h5 class="mb-1">Selective Work Visa Approvals</h5>
                                    <p class="text-muted small mb-0">Stringent scrutiny on Employment Visa and Top Talent Pass approvals require maintaining a high ratio of local Hong Kong staff.</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-start mb-3">
                                <i class="fa-solid fa-triangle-exclamation text-danger fs-5 me-3 mt-1"></i>
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Mandatory audits, DPO registration, and high financial penalties for PDPO non-compliance.</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Our hybrid onshore/nearshore model mitigates costs while preserving Hong Kong's jurisdiction quality.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="py-5">
            <div class="container">
                <div class="section-title-wrap">
                    ...
                    <div class="gold-divider"></div>
                    <p class="text-muted">Discover how Devotion Global elevated client engagement for enterprises operating in Hong Kong.</p>
                </div>
                    ...
                    <div class="col-md-6 col-lg-4 case-item fintech">
                        <div class="card-custom p-4 d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <span class="text-muted small">Central, Hong Kong</span>
                            </div>
                            <h5>HK PayTech Global</h5>
                            <p class="text-muted small flex-grow-1">Scaled a 24/7 Tier 2 customer response desk for cross-border payments under HKMA regulatory standards.</p>
                            ...
                            <p class="fst-italic text-muted small mb-0">"Devotion Global's Hong Kong team ensured 100% compliance with data laws while maintaining white-glove support."</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 case-item ecom">
                        <div class="card-custom p-4 d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <span class="text-muted small">Kowloon East Hub</span>
                            </div>
                            <h5>Asian Luxury Retail</h5>
                            <p class="text-muted small flex-grow-1">Deployed a trilingual (English, Cantonese, Mandarin) VIP concierge desk for high-net-worth online shoppers.</p>
                            <div class="p-3 bg-light rounded my-3">
                                <div class="row text-center">
                                    <div class="col-6 border-end">
                    ...
                    <div class="col-md-6 col-lg-4 case-item saas">
                        <div class="card-custom p-4 d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <span class="text-muted small">Cyberport Tech Hub</span>
                            </div>
                            ...
                            <p class="fst-italic text-muted small mb-0">"Their setup calculator was spot on. Transitioning our support team to Hong Kong was smooth and transparent."</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="page-inquiry" class="page-view">
        <section class="py-5 bg-light">
            <div class="container">
                <div class="section-title-wrap">
                    <span class="badge-gold">Get Started in Hong Kong</span>
                    <h2 class="section-title">Request a Tailored Hong Kong Proposal</h2>
                    <div class="gold-divider"></div>
                    <p class="text-muted">Fill in your support preferences and our Hong Kong jurisdiction team will formulate a custom blueprint within 24 hours.</p>
                </div>
                            ...
                            <form id="proposalForm" onsubmit="handleFormSubmit(event)">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="tel" class="form-control" placeholder="+852 8123 4567" required>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex flex-wrap gap-3 p-3 bg-light rounded border">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="langZh">Cantonese</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="langMn">
                                                <label class="form-check-label" for="langMn">Mandarin</label>
                                            </div>
                                            <div class="form-check">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" rows="4" placeholder="Mention specific Companies Registry compliance needs, CRM systems, or call volume expectations..."></textarea>
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-gold btn-lg w-100 py-3">Submit Hong Kong Proposal Request <i class="fa-solid fa-paper-plane ms-2"></i></button>
                                    </div>
                                </div>
                            </form>
                            <div id="formSuccessMessage" class="alert alert-success mt-4 d-none">
                                <i class="fa-solid fa-circle-check me-2 fs-5"></i>
                                <strong>Proposal Request Received!</strong> Our Hong Kong Jurisdiction Lead will contact you within 24 business hours with a tailored blueprint.
                            </div>
                        </div>
                    </div>
                </div>

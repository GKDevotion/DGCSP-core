...
<section id="asian-holding" class="section-padding">
    <div class="container">
        <div class="text-center max-w-800 mx-auto mb-5" data-aos="fade-up">
            <h2 class="section-heading">Asian Holding Company Gateway</h2>
            <p class="text-muted">Unrivaled treaty network across Asian economies for seamless cross-border commerce.</p>
        </div>
        ...
        <div class="row g-4">
            <div class="col-md-4" data-aos="fade-up">
                <div class="feature-card text-center">
                    ...
                    <h5>95+ DTA Treaties</h5>
                    <p class="text-muted small">Substantially reduce withholding tax rates on cross-border royalties, interest, and dividends throughout Asia.</p>
                </div>
            </div>
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                <div class="feature-card text-center">
                    ...
                    <p class="text-muted small">No foreign currency exchange restrictions or capital movement controls in and out of Singapore.</p>
                </div>
            </div>
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                <div class="feature-card text-center">
                    ...
                    <h5>ASEAN Gateway</h5>
                    <p class="text-muted small">Direct trade agreements with dynamic high-growth markets including Vietnam, Indonesia, and Philippines.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center gy-5">
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <p class="text-muted mb-4">Limited Partnerships (LP) & Variable Capital Companies (VCC) designed specifically for Private Equity, Venture Capital, and Ultra High Net Worth Family Offices.</p>
                <div class="d-flex gap-3 mb-3">
                ...
                <div class="d-flex gap-3 mb-3">
                    ...
                    <div>
                        <h6>VCC Sub-Fund Structuring</h6>
                        <p class="text-muted small mb-0">Segregate assets and liabilities across multiple sub-funds under a single umbrella framework.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6" data-aos="fade-left">
                <div class="card border-0 shadow-md p-4 bg-white">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item px-0 py-3 d-flex justify-content-between align-items-center">
                            <span>13O / 13U Family Office Tax Exemption Scheme</span>
                            <i class="fa-solid fa-check text-gold"></i>
                        </li>
                        <li class="list-group-item px-0 py-3 d-flex justify-content-between align-items-center">

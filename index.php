...
<section class="hero-services-wrapper position-relative overflow-hidden pb-5">
    ...
    <div class="container text-center mb-5 position-relative z-1">
        ...
        <p class="hero-subtitle text-secondary mx-auto">
            Focus on what matters the most: starting and growing your business, and leave the details to Devotion GlobalCSP.
        </p>
    </div>
...
<style>
    ...
    .tile-global {
      background-image: linear-gradient(135deg, rgba(15, 23, 42, 0.88), rgba(15, 23, 42, 0.65)), url('assets/images/global-entity.png');
      color: #ffffff;
      min-height: 290px;
    }

    .tile-accounting {
      background-image: linear-gradient(180deg, rgba(255, 255, 255, 0.95) 0%, rgba(255, 255, 255, 0.7) 100%), url('assets/images/account-tax.png');
      min-height: 290px;
    }

    .tile-fund {
      background-image: linear-gradient(180deg, rgba(255, 255, 255, 0.95) 0%, rgba(255, 255, 255, 0.6) 100%), url('assets/images/fund-service.png');
      min-height: 290px;
    }

    .tile-wealth {
      background-image: linear-gradient(180deg, rgba(255, 255, 255, 0.92) 0%, rgba(255, 255, 255, 0.4) 100%), url('assets/images/private-wealth.png');
      min-height: 520px;
    }

    .tile-mergers {
      background-image: linear-gradient(180deg, rgba(255, 255, 255, 0.92) 0%, rgba(243, 203, 182, 0.5) 100%), url('assets/images/merge-aquisition.png');
      min-height: 520px;
    }

    .tile-advisory {
      background-image: linear-gradient(135deg, rgba(247, 227, 190, 0.92) 0%, rgba(247, 227, 190, 0.65) 100%), url('assets/images/corporate-advisory.png');
      min-height: 245px;
    }

    .tile-banking {
      background-image: linear-gradient(180deg, rgba(255, 255, 255, 0.92) 0%, rgba(255, 255, 255, 0.5) 100%), url('assets/images/banking-solution.png');
      min-height: 245px;
    }
</style>
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <a href="#" class="service-tile tile-accounting shadow-sm h-100 theme-border">
                <div class="tile-content">
                    ...
                    Our experts are here to help you explore options, answer questions, and
                    </p>
                </div>
                <div class="tile-content pt-4">
...
<section class="offshore-jurisdictions-section position-relative py-5 bg-gray">
            ...
            <div class="col-12 col-lg-6 ps-lg-5">
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-column gap-3 max-width-pills">
                        <a href="#" class="license-pill-btn d-flex align-items-center gap-3 p-2 pe-4 rounded-pill shadow-sm">

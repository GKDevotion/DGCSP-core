            ...
            <div class="d-flex align-items-center flex-wrap gap-2 gap-lg-3">
                ...
                <div class="dropdown belt-dropdown dropdown-hover">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-0 py-2 jurisdiction-menu">
                        <li><a class="dropdown-item d-flex align-items-center gap-2" href="<?= getJurisditionLink( 'singapore' ) ?>"><span class="fi fi-sg rounded-1"></span>Singapore</a></li>
                        <li><a class="dropdown-item d-flex align-items-center gap-2" href="<?= getJurisditionLink( 'hongkong' ) ?>"><span class="fi fi-hk rounded-1"></span>Hongkong</a></li>
                        <li><a class="dropdown-item d-flex align-items-center gap-2" href="<?= getJurisditionLink( 'mauritius' ) ?>"><span class="fi fi-mu rounded-1"></span>Mauritius</a></li>
                        <li><a class="dropdown-item d-flex align-items-center gap-2" href="<?= getJurisditionLink( 'india' ) ?>"><span class="fi fi-in rounded-1"></span>India</a></li>
                        <li><a class="dropdown-item d-flex align-items-center gap-2" href="<?= getJurisditionLink( 'uae' ) ?>"><span class="fi fi-ae rounded-1"></span>UAE</a></li>
                        <li><a class="dropdown-item d-flex align-items-center gap-2" href="<?= getJurisditionLink( 'uk' ) ?>"><span class="fi fi-gb rounded-1"></span>United Kingdom</a></li>
                    </ul>
                </div>
            </div>
        </div>
